...
<!-- <div class="container"> -->
	<div class="col-sm-3" style="background-color:transparent;color:yellow; vertical-align:baseline">Customer Name </div>
			    <form:hidden path="customerid"/>
			      ...
			      <div class="col-sm-3" style="background-color:transparent;color:yellow;vertical-align:baseline"">Email ID </div>
			      <div class="col-sm-8" style="background-color:transparent">
			      ...
			      <div class="col-sm-3" style="background-color:transparent;color:yellow">Mobile No. 
			      <div class="col-sm-8" style="background-color:transparent">
